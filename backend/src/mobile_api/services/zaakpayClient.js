...
const configuredBaseUrl = process.env.ZAAKPAY_BASE_URL || 'https://sandbox.zaakpay.com';
// Auto-detect if Merchant ID is placeholder and switch to sandbox
const isPlaceholderMerchantId = merchantId && (merchantId.includes('xxxx') || merchantId.includes('your_merchant') || merchantId.length < 20);
const baseUrl = isPlaceholderMerchantId ? 'https://sandbox.zaakpay.com' : configuredBaseUrl;
